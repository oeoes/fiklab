...
@section('title', 'Dashboard - Tambah Kegiatan')
        ...
        <div class="row">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <textarea name="editor" class="form-control form-control-sm" id="editor"></textarea>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                    ...
                    <div class="card-body">
                        <form enctype="multipart/form-data" id="myform">
                            <div class="form-group">
                                ...
                                <input name="title" id="title" type="text" class="form-control form-control-sm" required>
                            </div>
                            <div class="form-group">
                                <label for="">Gambar</label>
                                <input name="image" id="file" type="file" class="form-control form-control-sm" required>
                            </div>
                            <div class="form-group">
                                <label for="">Selogan/Kata Pembuka</label>
                                <input name="subtitle" id="subtitle" type="text" class="form-control form-control-sm" required>
                            </div>
                            <div class="form-group">
                                <label for="">Tempat</label>
                                <input name="venue" id="venue" type="text" class="form-control form-control-sm" required>
                            </div>
                            <div class="form-group">
                                <label for="">Tanggal</label>
                                <input name="date" id="date" type="date" class="form-control form-control-sm" required>
                            </div>
                            <div class="form-group">
                                <label for="">Waktu</label>
                                <input name="time" id="time" type="time" class="form-control form-control-sm" required>
                            </div>
                    </div>
    ...
    window.onload = () => {
        ...
        btnSave.addEventListener('click', (e) => {
            ...
            if (image.length > 0) {
                ...
                axios.post('/app/admin/activity/store', fd).then((response) => {
                ...
                alert('Jangan lupa pilih gambar.')
            }
