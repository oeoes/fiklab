...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark">Update Program Magang</h1>
            </div>
        </div>
    </div>
</div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input name="title" id="title" type="text" class="form-control" value="{{ $internship->title }}" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="">Sub judul</label>
                                        <input name="subtitle" id="subtitle" type="text" class="form-control" value="{{ $internship->subtitle }}" required>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="">Detail</label>
                                <textarea name="editor" class="form-control" id="editor">{{ $internship->detail }}</textarea>
                            </div>
                    </div>
                    <div class="card-footer">
                        <button id="update" class="btn btn-sm btn-outline-primary">Update</button>
                        </form>
                    </div>
                </div>
            </div>
...
<script>
    window.onload = () => {
        ...
        btnUpdate.addEventListener('click', (e) => {
            ...
            axios.post(`/app/admin/magang/update/${magang_id}`, fd).then((response) => {
